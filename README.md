...
Pin an Independence Day Kitty sprite with `INDEPENDENCE_DAY_SPRITE_INDEX` from `1` through `3`; its ANSI fallback can be pinned with `INDEPENDENCE_DAY_ART_INDEX` from `0` through `2`.
